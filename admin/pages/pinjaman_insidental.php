...
<body>
    ...
    <aside id="logo-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform -translate-x-full bg-white border-r border-gray-200 sm:translate-x-0 -800 -700" aria-label="Sidebar">
        <div class="h-full px-3 pb-4 overflow-y-auto bg-white -800">
            <ul class="space-y-2 font-medium">
                ...
                <li>
                    <button type="button" class="flex items-center w-full p-2 text-base text-gray-900 transition duration-75 rounded-lg group bg-gray-100" aria-controls="pinjaman" data-collapse-toggle="pinjaman">
                  <!-- Ganti icon dengan font awesome -->
                  <i class="fas fa-credit-card w-5 h-5 text-gray-500 transition duration-75 text-gray-900"></i>
                  ...
                  <svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                    ...
                    <ul id="pinjaman" class="hidden py-2 space-y-2">
                        ...
                        <li>
                            <a href="./pinjaman_insidental.php" class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group bg-gray-100">Pinjaman Insidental</a>
                        </li>
                    </ul>
                </li>
                <li>
        ...
        <div class="p-4 mt-14">
            <div class="w-full p-4 bg-white border border-gray-200 rounded-lg shadow-sm sm:p-8 dark:bg-gray-800 dark:border-gray-700">
                <div class="mb-6 flex justify-between">
                    <h2 class="font-bold text-2xl">Data Pinjaman Insidental</h2>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 border-gray-200 hover:bg-gray-50 dark:hover:bg-gray-600">
                                    ...
                                    <td class="px-6 py-4">
                                        Rp <?= number_format($row['jumlah_angsuran'], 0, ',', '.') ?>
                                    </td>
                                </tr>
                            <?php endwhile ?>
                        </tbody>
    ...
    <div id="drawer-right-example" class="pt-20 fixed top-0 right-0 z-40 h-screen p-4 overflow-y-auto transition-transform translate-x-full bg-white w-80 dark:bg-gray-800" tabindex="-1" aria-labelledby="drawer-right-label">
        ...
        <form method="POST" action="../backend/pinjaman_insidental.php" class="mb-6" enctype="multipart/form-data">
            <div class="mb-6">
