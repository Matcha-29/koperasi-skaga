...
<body class="bg-gray-100 flex justify-center">
    <div class="w-full max-w-md min-h-screen bg-gray-200 relative">
        <div class="container mx-auto px-4 pb-24">
            <h1 class="text-2xl font-semibold text-center text-gray-800 my-6">Simpanan Wajib</h1>
            ...
            <div class="bg-white rounded-lg shadow-sm border-2 border-black">
                    <table class="w-full border border-gray-200 rounded-md overflow-hidden">
                        <thead>
                            <tr class="bg-red-50">
                                <th class="w-1/2 py-3 px-4 border-b text-left font-semibold text-black">Bulan</th>
                                <th class="w-1/2 py-3 px-4 border-b text-left font-semibold text-black">Jumlah Simpanan</th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php foreach ($simpananWajib as $bulan => $jumlah): ?>
                                <tr class="<?php echo in_array($bulan, $bulanKosong) ? 'bg-red-50' : ''; ?>">
                                    <td class="py-3 px-4 border-b"><?php echo $bulan; ?></td>
